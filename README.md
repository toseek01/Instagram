...
***M(j, 𝑆)*** - Маржинальный вклад. UserID которые посетили канал Xj + S (в том числе и нулевое множество) и совершили некий вклад</br>
...
***Shapley values*** - Аттрибутированные веса каналов ,после их прохождения через **Shapley algorithm***
